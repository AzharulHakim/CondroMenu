...
let food = [
    ...
    //Default
    {
        ...
        stok: 100,
        harga: 5000,
        image: './assets/images/IMG-20241222-WA0025.jpg',
        category: 'default'
    },
    {
        ...
        stok: 100,
        harga: 5000,
        image: './assets/images/IMG-20241222-WA0024.jpg',
        category: 'default'
    },
    {
        name: `Jeruk Manis (Es / Hangat)`,
        stok: 50,
        harga: 5000,
        image: './assets/images/IMG-20241222-WA0022.jpg',
        category: 'default'
    },
    {
        name: `Es Sirup`,
        stok: 50,
        harga: 5000,
        image: './assets/images/IMG-20241222-WA0023.jpg',
        category: 'default'
    },
    //Kopi
    {
        ...
        stok: 50,
        harga: 15000,
        image: './assets/images/IMG-20241222-WA0027.jpg',
        category: 'kopi'
    },
    {
        name: `Americano`,
        stok: 50,
        harga: 20000,
        image: './assets/images/IMG-20241222-WA0026.jpg',
        category: 'kopi'
    },
    {
        name: `Cappucino`,
        stok: 50,
        harga: 24000,
        image: './assets/images/IMG-20241222-WA0028.jpg',
        category: 'kopi'
    },
    {
        name: `Vietnam Drip`,
        stok: 50,
        harga: 24000,
        image: './assets/images/IMG-20241222-WA0029.jpg',
        category: 'kopi'
    },
    {
        name: `Cafe Latte`,
        stok: 50,
        harga: 24000,
        image: './assets/images/IMG-20241222-WA0030.jpg',
        category: 'kopi'
    },
    //Dessert
    {
        ...
        stok: 50,
        harga: 15000,
        image: './assets/images/IMG-20241222-WA0031.jpg',
        category: 'dessert'
    },
    {
        name: `Roti Tawar Es Krim`,
        stok: 50,
        harga: 20000,
        image: './assets/images/IMG-20241222-WA0032.jpg',
        category: 'dessert'
    },
    {
        name: `Es Krim Choco Chips`,
        stok: 50,
        harga: 25000,
        image: './assets/images/IMG-20241222-WA0033.jpg',
        category: 'dessert'
    }
];
...
function generateData() {
    ...
    defaultHeader.innerHTML = 'Minuman';
    foodList.appendChild(defaultHeader);

    for (var i = 0; i < food.length; i++) {
        if (food[i].category === 'default') {
            let name = food[i].name;
            let stok = food[i].stok;
            let harga = food[i].harga;
            let image = food[i].image;
    ...
    // Generate Default
    let kopiHeader = document.createElement('h2');
    kopiHeader.innerHTML = 'Coffe';
    foodList.appendChild(kopiHeader);

    for (var i = 0; i < food.length; i++) {
        if (food[i].category === 'kopi') {
            let name = food[i].name;
            let stok = food[i].stok;
            let harga = food[i].harga;
            let image = food[i].image;
    ...
    // Generate Dessert
    let dessertHeader = document.createElement('h2');
    dessertHeader.innerHTML = 'Dessert';
    foodList.appendChild(dessertHeader);

    for (var i = 0; i < food.length; i++) {
        if (food[i].category === 'dessert') {
            let name = food[i].name;
            let stok = food[i].stok;
            let harga = food[i].harga;
            let image = food[i].image;
